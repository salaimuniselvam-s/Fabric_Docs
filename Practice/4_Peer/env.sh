...
export  CONFIG_DIRECTORY=$PWD/../3_Orderer
...
export CORE_PEER_FILESYSTEMPATH=./ledgers
export PATH=${PWD}/../../bin:$PATH

# Identity set to Admin
export CORE_PEER_MSPCONFIGPATH=$CONFIG_DIRECTORY/crypto-config/peerOrganizations/hospital.com/users/Admin@hospital.com/msp
...
export NODECHAINCODE=./chaincode

# Default Chaincode variables
export CC_NAME=hospcc
