...
peer channel create -o $ORDERER_ADDRESS -c hospitalchannel -f $CONFIG_DIRECTORY/hospital-channel.tx

# peer channel create -o localhost:7050 -c hospitalchannel -f ../3_Orderer/hospital-channel.tx
...
#peer channel fetch 0 -o localhost:7050  -c hospitalchannel  hospital-genesis.block
...
# Error: received bad response, status 500: Invalid chain ID, hospital-genesis -> not yet joined the channel
